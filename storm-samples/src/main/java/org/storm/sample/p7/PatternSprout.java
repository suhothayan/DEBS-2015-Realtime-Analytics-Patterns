...
public class PatternSprout extends BaseRichSpout {
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declare(new Fields("timestamp", "customer", "amount"));
    ...
    public void open(Map conf, TopologyContext context, SpoutOutputCollector collector) {
        ...
        URL url = PatternSprout.class.getResource("/transactions.txt");
        try {
